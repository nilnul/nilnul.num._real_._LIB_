...
namespace nilnul.num.real.stream_.slider.op_.binary_._divide
{
	public class Of :
	...
	{
		public Of(SliderI arg, SliderI arg1) : base(arg, arg1, nilnul.num.real.op_.binary_.Divide.Singleton)
		{
		}
