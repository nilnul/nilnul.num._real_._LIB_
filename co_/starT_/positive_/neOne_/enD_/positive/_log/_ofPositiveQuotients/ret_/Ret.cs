...
namespace nilnul.num.real.co.band_._log._ofPositiveQuotients.ret_
{
	public class BothGtOne
		:nilnul.num.RealI
		
	{
		private nilnul.num.quotient_.GtOne _sub;

		public nilnul.num.quotient_.GtOne sub
		{
			get { return _sub; }
			set { _sub = value; }
		}

		private nilnul.num.quotient_.GtOne _target;

		public nilnul.num.quotient_.GtOne target
		{
			get { return _target; }
			set { _target = value; }
		}
		...
		public BothGtOne(
			...
			,
			nilnul.num.quotient_.GtOne target
		)
		{
			_sub = sub;
			_target = target;
		...
		public void squeeze(Positive1 diameter)
		{
			...
			var bound = nilnul.num.quotient.co_.startPositiveNeOne._LogX.Bound(newSub, newTarget);
