...
{
	/// <summary>
	/// <see cref="_algebraic.pows.prod.scaleds.Sum"/>
	/// </summary>
	///
	[Obsolete(nameof(expr_.polynom_.IUniVariate) + " as the name is preferred")]
	public class Polynomial : PolynomialI, expr_.polynom_.IUniVariate
	{
		/// <summary>
