...
namespace nilnul.num._real.limit.op.sqrt.call
{
		...
		nilnul.num._real.LimitI
	{
		...
		{
			converge(new quotient.be.Positive.Asserted(i));
		}

	

		public void converge(quotient.be.Positive.Asserted diameter)
		{
