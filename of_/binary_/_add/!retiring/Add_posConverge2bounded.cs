...
namespace nilnul.num.real.op
{
	...
	{
		static public real.RealI_posConverge2NonEmpty Eval(int a, real.RealI_posConverge2NonEmpty b) {
			return Eval(b, a);
		}
		static public real.RealI_posConverge2NonEmpty Eval(BigInteger a, real.RealI_posConverge2NonEmpty b) {
			return new Expr(a,b);
		}
	...
	static public real.RealI_posConverge2NonEmpty Eval(real.RealI_posConverge2NonEmpty a,real.RealI_posConverge2NonEmpty b) {
			...
			RealI_posConverge2NonEmpty
		{
			...
			public Expr(BigInteger a, R b) :this(new real.Rational_posConverge2Bounded(a),b) { }
