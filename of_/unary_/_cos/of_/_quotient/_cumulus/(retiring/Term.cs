...
namespace nilnul.num._real.approach.op_.uni_._cos.of_._quotient._series
{
	public class Term
		...
		)
		{
			...
			_slider = new nilnul.num.quotient.slider.op_.uni_._alter.Ret(
					nilnul.num.quotient.slider.op_.bi_.Div.Lazy.eval(
						new nilnul.num.quotient.slider_.geometric_.PolyEven(x)
						,
						new nilnul.num.quotient.slider_.fro_.Natural(new nilnul.num.slider_.EvenFactorial())
					)
			);
		}
