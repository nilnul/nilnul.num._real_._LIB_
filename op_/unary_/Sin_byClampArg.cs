...
{
	static public class _Sin_byClampArgX
	{
		...
		public static R RetRealI_ofRemainder(R arg)
		{
			...
			return new _sin.Ret_ofAcuteMaybeIrration_byClampArg(arg);
		}
		/// <summary>
		/// para may be large
		/// </summary>
		...
		public static R RetRealI(RealI arg)
		{
			...
			switch (roundMod4)
			{
				...
				case 1:
					///(-t/4, t/4)
					return _Cos_byClampArgX.RealI_ofRemainder(expressed);
				case 2:
					return RetRealI_ofRemainder(expressed).Negate();
				
				default:
					return _Cos_byClampArgX.RealI_ofRemainder(expressed).Negate();
					break;
			}
