...
,
	...
	{
		private const double _UNARD = double.PositiveInfinity;

		public Cumulator4dbl() : base(
			//double.NegativeInfinity  /// this is the <see cref="nilnul.obj.op_.binary.cumulator.be_.INardable"/>;but we need <see cref="nilnul.obj.op_.binary.cumulator.be_.UnardableI{T}"/>
			_UNARD
		)
		{
		}
