...
namespace nilnul.num.real.xt.fn_.confined_.strict.solve_
{
	/// <summary>
    ...
    static public  class _BinarySearchX
    {
		...
		/// <returns></returns>
		static public double? _Solve_1right_2strict_3tgt(double left, double right,Func<double, double> func, double expectedImg=0 )
		{
